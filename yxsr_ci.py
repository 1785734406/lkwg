...
def screenshot_merchant_hd(output_path=None):
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.wait_for_selector(".shop-box", timeout=10000)
            page.wait_for_selector(".shop-list", timeout=8000)
            page.wait_for_selector(".shop-list li", timeout=8000, state="attached")
